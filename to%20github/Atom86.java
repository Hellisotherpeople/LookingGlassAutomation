 ...
 * @author Allen
 */
public class Atom86 extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.atom86.net/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Atom86.class.getName()).log(Level.SEVERE, null, ex);
