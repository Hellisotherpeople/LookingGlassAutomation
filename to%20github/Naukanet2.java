 ...
 * @author Allen
 */
public class Naukanet2 extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.naukanet.ru/cgi-bin/results.cgi";
	...
	public String launch() {
		try {
			...
			c.method(Connection.Method.POST);
                        c.data("query", "traceroute");
			c.data("querystring", dstIP);
			c.data("submit3", "Traceroute");
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Naukanet2.class.getName()).log(Level.SEVERE, null, ex);
