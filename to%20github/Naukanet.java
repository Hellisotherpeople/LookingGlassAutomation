 ...
 * @author Allen
 */
public class Naukanet extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.naukanet.ru/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Naukanet.class.getName()).log(Level.SEVERE, null, ex);
