 ...
 * @author Allen
 */
public class CPRM extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://glass.cprm.net/output.php";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Document doc = c.post();
			result = doc.getElementsByTag("p").first().html();
		} catch (IOException ex) {
			Logger.getLogger(CPRM.class.getName()).log(Level.SEVERE, null, ex);
