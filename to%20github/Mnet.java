 ...
 * @author Allen
 */
public class Mnet extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.m-online.net/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Mnet.class.getName()).log(Level.SEVERE, null, ex);
