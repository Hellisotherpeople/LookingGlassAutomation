 ...
 * @author 
 */
public class Idola extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.idola.net.id/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Idola.class.getName()).log(Level.SEVERE, null, ex);
