...
/**
 *
 * @author motamedi + updated by Allen 
 */
public class SUNET extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://stats.sunet.se/looking-glass/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			result = doc.getElementsByTag("pre").first().text();
			System.out.println(result);
		} catch (IOException ex) {
			Logger.getLogger(SUNET.class.getName()).log(Level.SEVERE, null, ex);
			System.out.println(result);
		} finally {
			super.store();
			return result;
