 ...
 * @author Allen
 */
public class ActiveTech extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://eu104.activeby.net/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(ActiveTech.class.getName()).log(Level.SEVERE, null, ex);
