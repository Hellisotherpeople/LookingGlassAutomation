 ...
 * @author Allen
 */
public class Ipartners extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://cgi.ipartners.pl/cgi-bin/traceroute.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Ipartners.class.getName()).log(Level.SEVERE, null, ex);
