 ...
 * @author Allen 
 */
public class Cesnet extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "https://perfmon.cesnet.cz/mrlg/index.php";
	...
	public String launch() {
		try {
			...
			c.data("action", "execute");
                        c.data("routerid", locVar);
                        c.data("requestgroupid", "1");
                        c.data("requestid", "7");
			c.data("argument", dstIP);
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Cesnet.class.getName()).log(Level.SEVERE, null, ex);
