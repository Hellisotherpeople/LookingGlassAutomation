 ...
 * @author 
 */
public class Hkunicom extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.hkunicom.com/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Hkunicom.class.getName()).log(Level.SEVERE, null, ex);
