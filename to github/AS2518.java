 ...
 * @author Allen
 */
public class AS2518 extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(AS2518.class.getName()).log(Level.SEVERE, null, ex);
