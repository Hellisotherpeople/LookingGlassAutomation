 ...
 * @author Allen
 */
public class Eurotel extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.eurotele.net.ua/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Eurotel.class.getName()).log(Level.SEVERE, null, ex);
