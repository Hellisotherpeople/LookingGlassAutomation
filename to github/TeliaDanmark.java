 ...
 * @author Allen
 */
public class TeliaDanmark extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.drift.telia.dk/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(TeliaDanmark.class.getName()).log(Level.SEVERE, null, ex);
